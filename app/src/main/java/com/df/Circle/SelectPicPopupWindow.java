...
public class SelectPicPopupWindow extends PopupWindow{
	private Button takePhotBtn,pickPhotoBtn,cancelBtn;
	...
	public SelectPicPopupWindow(Context context,View.OnClickListener itemsOnClick){
		...
		takePhotBtn=(Button)mMenuView.findViewById(R.id.takePhotoBtn);
		...
		takePhotBtn.setOnClickListener(itemsOnClick);
